  ...
  return (
    <Box className="mt-20">
      <Container className='flex flex-col items-center'>
        <StyledTitle title="Popular Collections" classes="text-center text-[2.5rem] lg:text-[3rem]" />
        <Typography variant='h4' className='font-elegant text-[40px] text-center lg:text-6xl mt-1'>Top Catergories</Typography>
        <Typography variant='body2' component="p" className="font-elegant text-center text-[14px] mt-6 text-gray-500 max-w-lg lg:text-lg">
